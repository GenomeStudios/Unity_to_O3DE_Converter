...
materials referencing the TerrainBaseMaterial materialtype. Copies all
textures referenced by those materials into a sibling Textures folder.
...
Reuses AssetDatabase from integrated_asset_processor for GUID indexing and
Unity .mat parsing. AssetDatabase.parse_material already runs the property
reconciliation (metallic/roughness factor vs bounds, opacity mode, smoothness
handling), so we just consume its output and route it into a TerrainBaseMaterial
JSON envelope.
=============================================================================
"""
